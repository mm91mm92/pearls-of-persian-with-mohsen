...
* **Type:** String  
* **Required:** No  
* **Purpose:** Documents the poetic metrical pattern (وزن شعر) of the literary text using the classical aruz (عروض) system. [1]
* **Example:** `"فعولن فعولن فعولن فعل"` [1]

##### `prosody_name` [1]
* **Type:** String  
* **Required:** No  
* **Purpose:** Documents the canonical name of the poetic meter (بحر شعر). [1]
* **Example:** `"رمل مثمن محذوف"` [1]
